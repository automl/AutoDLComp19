...
parser.add_argument('--dataset', type=str, default='/home/ferreira/autodl_data/processed_datasets/1e4_meta')  # or '/home/ferreira/autodl_data/processed_datasets/1e4_combined'
