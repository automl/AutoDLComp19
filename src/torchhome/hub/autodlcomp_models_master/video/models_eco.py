...
TSN Configurations:
    ...
    def _prepare_base_model(self, base_model):  # noqa: C901
    ...
    def get_optim_policies(self):  # noqa: C901
    ...
    def get_optim_policies_BN2to1D(self):  # noqa: C901
        first_conv_weight = []
        first_conv_bias = []
        normal_weight = []
        normal_bias = []
    ...
    def forward(self, input, *feature_name):  # noqa: C901
        ...
        if self.base_model_name == "ECOfull":
        ...
        if self.reshape:
            ...
            if self.base_model_name == 'C3DRes18':
                ...
                return output
            elif self.base_model_name == 'ECO' or self.base_model_name == 'ECOfull':
                output = base_out
                output = self.consensus(base_out)
                if feature_name:
                    return feature_out, output
                else:
                    return output
