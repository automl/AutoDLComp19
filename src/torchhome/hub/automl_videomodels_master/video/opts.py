...
parser.add_argument(
    '--modality', type=str, default='RGB', choices=['RGB', 'Flow', 'RGBDiff']
)
parser.add_argument('--working_directory', default='.', help='path to working directory')
parser.add_argument('--finetune_model', type=str, default=None)
parser.add_argument('--training', help="If set, set config and run without bohb")
# ========================= Bohb Configs ==========================
...
parser.add_argument(
    '--val_perc', type=float, default=1., help="Percentage of validation examples"
)
# ========================= Model Configs ==========================
parser.add_argument(
    '--arch',
...
parser.add_argument('--loss_type', type=str, default="nll", choices=['nll', 'normal'])
parser.add_argument(
    '--img_feature_dim',
    default=256,
    type=int,
...
parser.add_argument(
    '--freeze_interval', '--fz_i', type=int, default=[2, 63, -1, -1], nargs="+"
)
parser.add_argument('--pretrain', type=str, default='imagenet')
parser.add_argument('--freeze_portion', type=float, default=0)
# ========================= Learning Configs ==========================
parser.add_argument(
    '--epochs', default=45, type=int, metavar='N', help='number of total epochs to run'
)
parser.add_argument(
    '-b',
    '--batch-size',
...
parser.add_argument(
    ...
    type=int,
    metavar='N',
    help='number of iterations before on update'
)
parser.add_argument(
    '--lr',
    '--learning-rate',
...
parser.add_argument('--freeze_eco', '--feco', default=False, action="store_true")
...
parser.add_argument('--num_saturate', type=int, default=5, help=temp_str)
...
parser.add_argument(
    '--print', default=True, type=bool, help='If True print while training'
)
parser.add_argument(
    '--eval-freq',
    '-ef',
...
parser.add_argument(
    '--shift', default=False, action="store_true", help='use shift for models'
)
parser.add_argument(
    '--shift_div', default=8, type=int, help='number of div for shift (default: 8)'
)
parser.add_argument(
    '--shift_place',
    default='blockres',
...
parser.add_argument(
    '--temporal_pool', default=False, action="store_true", help='add temporal pooling'
)
parser.add_argument(
    '--non_local', default=False, action="store_true", help='add non local block'
)
