...
def generate_samples_meta(dataset_dir_raw_in, dataset_dir_out, des_num_samples):
    ...
    dataset_train = AutoDLDataset(os.path.join(dataset_dir_raw_in, dataset_name +'.data', 'train')).get_dataset()
    dataset_test = AutoDLDataset(os.path.join(dataset_dir_raw_in, dataset_name +'.data', 'test')).get_dataset()
...
def generate_samples_combined(dataset_resnet_path_in, dataset_meta_path_in, dataset_combined_dir_out):
    '''
...
if __name__ == "__main__":
    ...
    generate_samples_combined(dataset_resnet_path_in, dataset_meta_path_in, dataset_combined_dir_out)
