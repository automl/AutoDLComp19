...
if __name__ == "__main__":
    ...
    best_result_path = '/home/dingsda/autodl/AutoDLComp19/src/video3/autodl_starting_kit_stable/common/files/incumbent.json'
    # filder with the AutoDL dataset
    dataset_raw_dir = '/home/dingsda/data/datasets/challenge/image/mnist'
    # folder containing all pretraind models
    model_dir = '/home/dingsda/autodl/AutoDLComp19/src/video3/autodl_starting_kit_stable/common/files'
    _, dataset_name = os.path.split(dataset_raw_dir)
