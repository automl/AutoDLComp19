...
if __name__ == "__main__":
    ...
    try:
        ...
        config_file_path = os.path.join(
            '/home/zelaa/AutoCV2/autodl_starting_kit_stable/',
            "scoring_output/{}_{}_{}".format(dataset_name, time_budget, task_id)
        )

        M = Model(D_train.get_metadata(), config_file_path)
        ###### End creating model ######
        ...
        while (not (use_done_training_api and M.done_training)):
            ...
            Y_pred = M.test(
                D_test.get_dataset(), remaining_time_budget=remaining_time_budget
            )
