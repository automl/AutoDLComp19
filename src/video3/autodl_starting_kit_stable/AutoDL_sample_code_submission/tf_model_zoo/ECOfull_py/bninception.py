...
class BNInception_org(nn.Module):

    def __init__(self, num_classes=1000):
        super(BNInception_org, self).__init__()
        inplace = True
...
class BNInception_full_pre(nn.Module):
    def __init__(self, num_classes=1000):
        super(BNInception_full_pre, self).__init__()
        inplace = True
    ...
    def features_full(self, input, input1, input2):
        inception_3c_double_3x3_2_out = self.inception_3c_double_3x3_2(input)
        ...
        inception_3c_pool_out = self.inception_3c_pool(input1)
        inception_3c_output_out = torch.cat(
            [input2, inception_3c_relu_double_3x3_2_out, inception_3c_pool_out], 1
        )
        inception_4a_1x1_out = self.inception_4a_1x1(inception_3c_output_out)
        inception_4a_1x1_bn_out = self.inception_4a_1x1_bn(inception_4a_1x1_out)
        inception_4a_relu_1x1_out = self.inception_4a_relu_1x1(inception_4a_1x1_bn_out)
    ...
    def features(self, input):
        ...
        return inception_3c_relu_double_3x3_1_out, inception_3b_output_out, inception_3c_relu_3x3_out
    ...
    def forward(self, input):
        x_a, x1, x2 = self.features(input)
        x_b = self.features_full(x_a, x1, x2)
        x_b = self.logits(x_b)
...
def bninception_pretrained(num_classes=1000, pretrained='imagenet', eco_version="full"):
    ...
    elif eco_version == "bninception":
        model = BNInception_org(num_classes=num_classes)
