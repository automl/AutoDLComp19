...
def get_configspace():
    ...
    cs.add_hyperparameter(CSH.CategoricalHyperparameter('num_segments_train', choices = [2,4,8,16]))
    cs.add_hyperparameter(CSH.CategoricalHyperparameter('num_segments_test', choices = [2,4,8,16]))
    cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='num_segments_threshold', lower=1, upper=300, log=False))
    cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='dropout_max', lower=0, upper=1.5, log=False))
    ...
    cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='lr_schedule', lower=0.9, upper=1, log=False))
    cs.add_hyperparameter(CSH.UniformFloatHyperparameter(name='lr_schedule_step', lower=10, upper=1000, log=True))
