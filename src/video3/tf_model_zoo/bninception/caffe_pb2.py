...
_VIDEODATAPARAMETER_MODALITY = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='RGB', index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name='FLOW', index=1, number=1, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_REDUCTIONPARAMETER_REDUCTIONOP = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='TOPK', index=4, number=5, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_LAYERPARAMETER.fields_by_name['contrastive_loss_param'
...
_LAYERPARAMETER.fields_by_name['infogain_loss_param'
                              ].message_type = _INFOGAINLOSSPARAMETER
_LAYERPARAMETER.fields_by_name['inner_product_param'
...
_LAYERPARAMETER.fields_by_name['batch_reduction_param'
                              ].message_type = _BATCHREDUCTIONPARAMETER
...
_REDUCTIONPARAMETER.fields_by_name['operation'
...
_V1LAYERPARAMETER.fields_by_name['blob_share_mode'
...
_V1LAYERPARAMETER.fields_by_name['contrastive_loss_param'
                                ].message_type = _CONTRASTIVELOSSPARAMETER
...
_V1LAYERPARAMETER.fields_by_name['infogain_loss_param'
                                ].message_type = _INFOGAINLOSSPARAMETER
_V1LAYERPARAMETER.fields_by_name['inner_product_param'
                                ].message_type = _INNERPRODUCTPARAMETER
...
_V1LAYERPARAMETER.fields_by_name['transform_param'
...
_BATCHREDUCTIONPARAMETER.fields_by_name['reduction_param'
                                       ].message_type = _REDUCTIONPARAMETER
...
DESCRIPTOR.message_types_by_name['MemoryOptimizationParameter'
