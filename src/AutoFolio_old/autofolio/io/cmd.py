...
class CMDParser(object):
    def __init__(self):
        ...
        csv.add_argument(
            ...
            default=None,
            help=
            "instance features data in csv table (column: features, row: instance, delimeter: ,)",
        )
        csv.add_argument(
            "--cv_csv",
            default=None,
        ...
        opt.add_argument(
            ...
            type=str,
            default=None,
            help="trains AutoFolio_old and saves AutoFolio_old's state in the given filename",
        )
        opt.add_argument(
            "--load",
            type=str,
