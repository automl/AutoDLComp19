# -*- coding: utf-8 -*-
#
# AutoFolio_old documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "AutoFolio_old.tex", "AutoFolio_old Documentation", autofolio.AUTHORS, "manual"),
]
...
man_pages = [(master_doc, "autofolio", "AutoFolio_old Documentation", [author], 1)]
