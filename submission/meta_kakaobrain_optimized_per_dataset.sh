...
#SBATCH -o experiments/kakaobrain_optimized_per_dataset_test_%A-%a.%x.out
#SBATCH -e experiments/kakaobrain_optimized_per_dataset_test_%A-%a.%x.err

#SBATCH --job-name opt_p_ds
